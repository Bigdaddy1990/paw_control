...
class PawControlFeedMorningButton(PawControlButtonEntity):
    ...
    async def async_press(self) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to record morning feeding for %s: %s", self._dog_name, e
            )
...
class PawControlFeedEveningButton(PawControlButtonEntity):
    ...
    async def async_press(self) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to record evening feeding for %s: %s", self._dog_name, e
            )
...
class PawControlMarkOutsideButton(PawControlButtonEntity):
    ...
    async def async_press(self) -> None:
        ...
        try:
            ...
            _LOGGER.exception("Failed to mark %s as outside: %s", self._dog_name, e)
...
class PawControlMarkPoopDoneButton(PawControlButtonEntity):
    ...
    async def async_press(self) -> None:
        ...
        try:
            ...
            _LOGGER.exception("Failed to mark poop done for %s: %s", self._dog_name, e)
    ...
    async def async_press(self) -> None:
        ...
        try:
            ...
            for entity_id in counter_entities:
                await self._safe_service_call(
                    "counter", "reset", {"entity_id": entity_id}
                )

            _LOGGER.info("Daily data reset for %s", self._dog_name)
        except Exception as e:
            _LOGGER.exception(
                "Failed to reset daily data for %s: %s", self._dog_name, e
            )
...
class PawControlEmergencyButton(PawControlButtonEntity):
    ...
    async def async_press(self) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to activate emergency for %s: %s", self._dog_name, e
            )
    ...
    async def async_press(self) -> None:
        ...
        try:
            ...
            visitor_state = self.hass.states.get(
                f"input_boolean.{self._dog_name}_visitor_mode"
            )
            ...
            _LOGGER.exception(
                "Failed to toggle visitor mode for %s: %s", self._dog_name, e
            )
...
class PawControlUpdateGPSButton(PawControlButtonEntity):
    ...
    async def async_press(self) -> None:
        ...
        try:
            ...
            _LOGGER.exception("Failed to update GPS for %s: %s", self._dog_name, e)
