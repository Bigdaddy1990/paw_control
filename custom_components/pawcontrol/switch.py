...
class PawControlEmergencyModeSwitch(PawControlSwitchEntity):
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to activate emergency mode for %s: %s", self._dog_name, e
            )
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to deactivate emergency mode for %s: %s", self._dog_name, e
            )
...
class PawControlVisitorModeSwitch(PawControlSwitchEntity):
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to activate visitor mode for %s: %s", self._dog_name, e
            )
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to deactivate visitor mode for %s: %s", self._dog_name, e
            )
...
class PawControlAutoWalkDetectionSwitch(PawControlSwitchEntity):
    ...
    def __init__(self, coordinator: PawControlCoordinator, dog_name: str) -> None:
        ...
        super().__init__(
            coordinator,
            dog_name=dog_name,
            key="auto_walk_detection",
            icon=get_icon("automation"),
        )
    ...
    def is_on(self) -> bool | None:
        """Return true if the switch is on."""
        try:
            auto_walk_state = self.hass.states.get(
                f"input_boolean.{self._dog_name}_auto_walk_detection"
            )
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to enable auto walk detection for %s: %s", self._dog_name, e
            )
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to disable auto walk detection for %s: %s", self._dog_name, e
            )
...
class PawControlWalkInProgressSwitch(PawControlSwitchEntity):
    ...
    def is_on(self) -> bool | None:
        """Return true if the switch is on."""
        try:
            walk_state = self.hass.states.get(
                f"input_boolean.{self._dog_name}_walk_in_progress"
            )
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception("Failed to start walk for %s: %s", self._dog_name, e)
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception("Failed to end walk for %s: %s", self._dog_name, e)
...
class PawControlTrainingSessionSwitch(PawControlSwitchEntity):
    ...
    def is_on(self) -> bool | None:
        """Return true if the switch is on."""
        try:
            training_state = self.hass.states.get(
                f"input_boolean.{self._dog_name}_training_session"
            )
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to start training session for %s: %s", self._dog_name, e
            )
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to end training session for %s: %s", self._dog_name, e
            )
...
class PawControlPlaytimeSessionSwitch(PawControlSwitchEntity):
    ...
    def is_on(self) -> bool | None:
        """Return true if the switch is on."""
        try:
            playtime_state = self.hass.states.get(
                f"input_boolean.{self._dog_name}_playtime_session"
            )
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to start playtime session for %s: %s", self._dog_name, e
            )
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to end playtime session for %s: %s", self._dog_name, e
            )
...
class PawControlMedicationReminderSwitch(PawControlSwitchEntity):
    ...
    def is_on(self) -> bool | None:
        ...
        try:
            medication_state = self.hass.states.get(
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to enable medication reminder for %s: %s", self._dog_name, e
            )
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to mark medication as given for %s: %s", self._dog_name, e
            )
...
class PawControlHealthMonitoringSwitch(PawControlSwitchEntity):
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to activate health monitoring for %s: %s", self._dog_name, e
            )
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.exception(
                "Failed to update health monitoring for %s: %s", self._dog_name, e
            )
